<?php /* Smarty version 2.6.11, created on 2012-09-06 08:53:41
         compiled from cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 42, false),array('function', 'counter', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 47, false),array('function', 'sugar_translate', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 53, false),array('function', 'html_options', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 84, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 122, false),array('modifier', 'default', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 48, false),array('modifier', 'strip_semicolon', 'cache/modules/Calls/form_SubpanelQuickCreate_Calls.tpl', 54, false),)), $this); ?>
...
" class="button" onclick="this.form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Calls'))return SUGAR.subpanelUtils.inlineSave(this.form.id, 'Calls_subpanel_save_button');return false;" type="submit" name="Calls_subpanel_save_button" id="Calls_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"><?php endif; ?> 
<input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate('Calls_subpanel_cancel_button');return false;" type="submit" name="Calls_subpanel_cancel_button" id="Calls_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
"> 
...
<input tabindex="104"  id="duration_hours" name="duration_hours" tabindex="1" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
...
<?php if ($this->_tpl_vars['fields']['reminder_checked']['value'] == '1'):  $this->assign('REMINDER_TIME_DISPLAY', 'inline');  $this->assign('REMINDER_CHECKED', 'checked');  else:  $this->assign('REMINDER_TIME_DISPLAY', 'none');  $this->assign('REMINDER_CHECKED', "");  endif; ?><input tabindex="105"  name="reminder_checked" type="hidden" value="0"><input tabindex="105"  name="reminder_checked" onclick='toggleDisplay("should_remind_list");' type="checkbox" class="checkbox" value="1" <?php echo $this->_tpl_vars['REMINDER_CHECKED']; ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QUICKCREATE_PANEL1','module' => 'Calls'), $this);?>
</h4>
</th>
</tr>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
<?php if ($this->_tpl_vars['panelFieldCount'] == 0): ?>
<script>document.getElementById("LBL_QUICKCREATE_PANEL1").style.display='none';</script>
<?php endif; ?>
</div></div>
...
<script type="text/javascript">
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'date_end_date\', \'date\', false,\'Date End\' );
...
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'reminder_time\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER_TIME','module' => 'Calls','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'accept_status\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'set_accept_links\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Calls','for_js' => true), $this); echo '\' );
