<?php /* Smarty version 2.6.11, created on 2012-09-06 23:04:34
         compiled from cache/modules/zr2_ReportContainer/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 29, false),array('function', 'counter', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 43, false),array('modifier', 'strip_semicolon', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 44, false),array('modifier', 'escape', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 128, false),array('modifier', 'url2html', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 128, false),array('modifier', 'nl2br', 'cache/modules/zr2_ReportContainer/DetailView.tpl', 128, false),)), $this); ?>
...
" class="button primary" onclick="this.form.return_module.value='zr2_ReportContainer'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='zr2_ReportContainer'; this.form.return_action.value='DetailView'; this.form.isDuplicate.value=true; this.form.action.value='EditView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='zr2_ReportContainer'; this.form.return_action.value='ListView'; this.form.action.value='Delete'; return confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" accessKey="M" class="button" onclick="this.form.return_module.value='zr2_ReportContainer'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="zr2_ReportContainer_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['date_entered']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'zr2_ReportContainer'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
