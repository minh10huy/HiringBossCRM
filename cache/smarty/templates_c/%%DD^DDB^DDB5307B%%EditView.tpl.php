...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Meetings/EditView.tpl', 43, false),array('function', 'counter', 'cache/modules/Meetings/EditView.tpl', 48, false),array('function', 'sugar_translate', 'cache/modules/Meetings/EditView.tpl', 52, false),array('function', 'html_options', 'cache/modules/Meetings/EditView.tpl', 89, false),array('function', 'sugar_getimagepath', 'cache/modules/Meetings/EditView.tpl', 115, false),array('modifier', 'default', 'cache/modules/Meetings/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Meetings/EditView.tpl', 60, false),)), $this); ?>
...
" id ="SAVE" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
...
" class="button" onclick="document.EditView.send_invites.value='1';fill_invitees();document.EditView.action.value='Save';document.EditView.return_action.value='DetailView';document.EditView.return_module.value='<?php echo $_REQUEST['return_module']; ?>
...
<div class="duration"><input tabindex="104"  name="duration_hours" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
...
<?php if ($this->_tpl_vars['fields']['reminder_checked']['value'] == '1'):  $this->assign('REMINDER_TIME_DISPLAY', 'inline');  $this->assign('REMINDER_CHECKED', 'checked');  else:  $this->assign('REMINDER_TIME_DISPLAY', 'none');  $this->assign('REMINDER_CHECKED', "");  endif; ?><input tabindex="106"  name="reminder_checked" type="hidden" value="0"><input tabindex="106"  name="reminder_checked" onclick='toggleDisplay("should_remind_list");' type="checkbox" class="checkbox" value="1" <?php echo $this->_tpl_vars['REMINDER_CHECKED']; ?>
