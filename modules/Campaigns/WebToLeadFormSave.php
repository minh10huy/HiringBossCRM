...
$guid = create_guid();
$form_file = "{$GLOBALS['sugar_config']['upload_dir']}$guid";
...
$webformlink .= "<a href=\"index.php?entryPoint=download&id={$guid}&tempName=WebToLeadForm.html&isTempFile=1&type=web2lead\">$mod_strings[LBL_DOWNLOAD_WEB_TO_LEAD_FORM]</a>";
