...
function handleSave($prefix,$redirect=true, $useRequired=false){
	...
	$query = "select opplist_c from accounts_cstm where id_c='".$_POST[$prefix.'account_id']."'";
	$r = $opp->db->query($query);
	while($a = $opp->db->fetchByAssoc($r)){
		$b = $a['opplist_c'];
	}
	if($b == '_none') {
		if($_POST[$prefix.'sales_stage'] == 'Closed Lost'){
			$query = "update accounts_cstm set opplist_c ='ofred' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
			$query = "update accounts_cstm set onem_c = 'onemgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
		}elseif($_POST[$prefix.'sales_stage'] == 'Closed Won'){
			$query = "update accounts_cstm set opplist_c ='osgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
			$query = "update accounts_cstm set twom_c ='tmgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
			$query = "update accounts_cstm set accsigned_c ='accorange' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
			$query = "update accounts_cstm set onem_c = 'onemgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
		}elseif($_POST[$prefix.'sales_stage'] == 'Proposal/Price Quote'){
			$query = "update accounts_cstm set opplist_c = 'oorange' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
			$query = "update accounts_cstm set onem_c = 'onemgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
			$opp->db->query($query);
		}else {
		...
		$query = "select twom_c from accounts_cstm where id_c='".$_POST[$prefix.'account_id']."'";
		$r = $opp->db->query($query);
		while($a = $opp->db->fetchByAssoc($r)){
			$b = $a['twom_c'];
		}
		if($b == '_none') {
			...
			if($_POST[$prefix.'sales_stage'] == 'Closed Lost'){
				$query = "update accounts_cstm set twom_c ='tmfred' where id_c ='".$_POST[$prefix.'account_id']."'";
				$opp->db->query($query);
			}elseif($_POST[$prefix.'sales_stage'] == 'Closed Won'){
				$query = "update accounts_cstm set twom_c ='tmgreen' where id_c ='".$_POST[$prefix.'account_id']."'";
				$opp->db->query($query);
				...
				$query = "update accounts_cstm set twom_c = 'tmorange' where id_c ='".$_POST[$prefix.'account_id']."'";
				$opp->db->query($query);
			}
		}
	}	
