...
class CallsViewEdit extends ViewEdit
{
 	...
 	var $where1 = "opportunities_cstm.opplist_c in ('ofred', 'osred')";
 	var $where2 = "opportunities_cstm.opplist_c in ('oorange')";
 	var $where3 = "opportunities_cstm.opplist_c in ('ofgreen', 'osgreen')";
 	function listViewProcess(){
 		//if($_GET['saved_search_select'] = '94824fc2-1a80-60b4-e1df-502a0376564d'){
 		if(isset($_GET['saved_search_select'])){
 		die('the end');
