...
class RejectedColdCallsAccountsDashlet extends DashletGeneric { 
    function RejectedColdCallsAccountsDashlet($id, $def = null) {
		global $current_user, $app_strings;
		require('modules/Accounts/Dashlets/RejectedColdCallsAccountsDashlet/RejectedColdCallsAccountsDashlet.data.php');
	...
	function process($lvsParams = array()) {
		...
		$lvsParams = array(
	     		        'custom_where' => ' AND (accounts.id in (select acstm.id_c from accounts_cstm acstm where acstm.coldcalls_c in (\'ccred\')))',          
					); 
		}
