...
function handleSave($prefix,$redirect=true, $useRequired=false){
    ...
    $return_id = $focus->id;
	/*Update status Company and status oragen of cold call*/    
	if(!empty($return_id)){
		$query = "update accounts_cstm set company_c = 'cogreen' where id_c = '$return_id'";
		$focus->db->query($query);
		$query = "update accounts_cstm set coldcalls_c = 'ccorange' where id_c = '$return_id'";
		$focus->db->query($query);
	}
    //Create company change status orange cold call
